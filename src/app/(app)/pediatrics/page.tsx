        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <CardContent className="flex flex-col gap-2">
                    ...
                    <Button size="sm" className="mt-2" onClick={() => router.push('/pediatrics/vaccines')}><Syringe className="mr-2 h-4 w-4"/> Gérer les vaccins</Button>
                </CardContent>
                </Card>
                <Card>
                <CardHeader>
                ...
                <CardContent className="flex flex-col gap-2">
                    ...
                    <Button variant="outline" onClick={() => router.push('/pediatrics/playroom')}><ToyBrick className="mr-2 h-4 w-4"/> Gérer la salle de jeux</Button>
                </CardContent>
                </Card>
            </div>
        </div>
